...
use crate::{errors::StakeProgramError, state::{stake_account::StakeAccount, user_account::UserAccount, StakeConfig}};
...
impl<'info> Unstake<'info> {
    pub fn unstake(&mut self) -> Result<()> {
        ...
        require!(!time_elapsed >= self.config.freeze_period, StakeProgramError::FreezePeriodNotPassed);
